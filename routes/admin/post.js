...
router.route('/new')
    .get(function(req, res) {
        res.render('admin/post.hbs', {id: 'new', title: '编辑博文', active_post: true});
    })
...
router.route('/:id')
    .get(function(req, res) {
        Post.findById(req.params.id, function(err, post) {
            if (err) return next(err);
            return res.render('admin/post.hbs', {post: post, id: post.id, title: '编辑博文', active_post: true});
        });
    })
